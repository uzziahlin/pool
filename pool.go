...
func NewConnPool[T Closer](maxActive int, maxIdleTime time.Duration, factory func() T) *ConnPool[T] {
	return &ConnPool[T]{
		idleConns:   make(chan *Conn[T], maxActive),
		maxActive:   maxActive,
		maxIdleTime: maxIdleTime,
		waitQ:       make(map[uint64]chan *Conn[T]),
		factory:     factory,
	}
}
